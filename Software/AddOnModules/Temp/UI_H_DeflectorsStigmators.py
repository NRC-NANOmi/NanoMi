...
#****************************************************************************************************************
    ...
    def scanGeneration(self):
        ...
        if test:
            ...
            exif_dict={"0th":{piexif.ImageIFD.XPComment:str.encode('xpcomments test')}}
            exif_bytes=piexif.dump(exif_dict)
            #im.modify_exif({"Exif.Photo.UserComment":"Testing comments"})
            im.save(imageFilename,exif=exif_bytes)
