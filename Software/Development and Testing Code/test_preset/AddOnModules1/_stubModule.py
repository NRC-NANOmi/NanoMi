...
NANOmi Electron Microscope ******* Module
...
buttonName = 'Insert Name Here'         #name of the button on the main window that links to this code
...
#****************************************************************************************************************
    ...
    def initUI(self):
        ...
        #name the window
        self.setWindowTitle('Set Window Title Name Here')
