...
'''
This was previously used to be used when plotting wasn't real time
'''
...
class Plot_Window(QtWidgets.QMainWindow):
    ...
    def show_plot_window(self):
        ...
        # x_range is the x axis range of the plot to represent last 60 seconds 
...
class Incrementor(QWidget):
    ...
    def on_click_read_txt_file(self):
        ...
        try:
            ...
            text = file.read()
            # get the number only in the file
